...
document.getElementById("tshirt").addEventListener("click",()=>getpro("tshirt"))
document.getElementById("shirt").addEventListener("click",()=>getpro("shirt"))
document.getElementById("jackets").addEventListener("click",()=>getpro("jackets"))
document.getElementById("sweaters").addEventListener("click",()=>getpro("sweaters"))
document.getElementById("trousers").addEventListener("click",()=>getpro("trousers"))
document.getElementById("jeans").addEventListener("click",()=>getpro("jeans"))
document.getElementById("sweatshirts").addEventListener("click",()=>getpro("sweatshirts"))
document.getElementById("swimbottoms").addEventListener("click",()=>getpro("swimbottoms"))